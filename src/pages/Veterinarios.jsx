...
const vets = [
  {
    ...
    lat: -7.99928525150826,
    lng: -34.84281527336404,
    rating: 4.7,
  ...
  {
    id: 2,
    nome: "Amigo Fiel Olinda - Hospital Veterinário 24h",
    lat: -8.010893957549667,
    lng: -34.84275490647923,
    rating: 4.5,
    address: "Av. Pres. Getúlio Vargas, 76 - Bairro Novo",
    phone: "(81) 3439-1533",
  },
  {
    id: 3,
    nome: "Clínica Veterinária de Olinda",
    lat: -7.990549318623497,
    lng: -34.839865631559576,
    rating: 4.8,
    address: "Av. Dr. José Augusto Moreira, 489a - Casa Caiada",
    phone: "(81) 3429-4040",
  },
  {
    id: 4,
    nome: "Planeta Animal",
    lat: -7.979029626888666,
    lng: -34.83602069291685,
    rating: 4.6,
    address: "Av. Gov. Carlos de Lima Cavalcanti, 3002",
    phone: "(81) 3432-6060",
  },
  {
    id: 5,
    nome: "Cats & Dogs - Clínica Veterinária",
    lat: -8.003947423170162,
    lng: -34.84062693468356,
    rating: 4.4,
    address: "Av. Pres. Getúlio Vargas, 766 - Bairro Novo",
    phone: "(81) 3429-0099",
  },
];

// Centro focado em Bairro Novo/Casa Caiada (em terra firme)
const OLINDA_CENTER = [-8.0, -34.842];
    ...
    <div className="h-[calc(100vh-100px)] flex flex-col md:flex-row gap-4">
      ...
      <div className="w-full md:w-1/3 space-y-4 overflow-y-auto pr-2 h-full">
        ...
        <p className="text-sm text-gray-500 mb-4">
          Especialistas encontrados na região.
        </p>

        {vets.map((vet) => (
          <Card
            key={vet.id}
            className="p-4 cursor-pointer hover:border-blue-400 hover:shadow-md transition-all group bg-white"
          >
            <div className="flex justify-between items-start">
              <div>
                <h3 className="font-bold text-gray-800 group-hover:text-blue-600 text-sm md:text-base">
                  {vet.nome}
                </h3>
